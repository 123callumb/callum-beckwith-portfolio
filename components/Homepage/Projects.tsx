    ...
    return <Flex bgColor={"white"} py="100px">
        <Container maxW={"4xl"} flexDirection={"column"} w="100%" columns={{ md: 2, sm: 1, base: 1 }}>
            ...
            <ScaleIntoView style={{ width: '100%', marginBottom: "2%" }}>
                <Flex w="100%" bgColor="#52b291" borderRadius={"5px"} color="white" p="8" height={"350px"} overflowY={"hidden"}>
                    <Box mr="40px" w="40%">
            ...
            <Flex>
                <ScaleIntoView style={{ width: '49%' }}>
                    <Flex w="100%" bgColor="#f15d5e" borderRadius={"5px"} color="white" p="8" height={"350px"} flexDir="column" overflowY={"hidden"}>
                        <Box>
                            <Text>Webur</Text>
                ...
                <Spacer />
                <ScaleIntoView style={{ width: '49%' }}>
                    <Flex w="100%" bgColor="#6B163F" borderRadius={"5px"} color="white" p="8" height={"350px"} flexDir="column" overflowY={"hidden"}>
                        <Box>
